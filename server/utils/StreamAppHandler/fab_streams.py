...
@task(default=True)
def local_deploy(system_name="0000", stream_name="test-stream", stream=None):
    """
    Deploys a stream with the given parameters locally
    :param system_name: UUID of the system - unique RAMI 4.0 station
...
@task
def local_down(system_name="0000", stream_name="test-stream"):
    """
...
@task
def local_is_deployed(system_name="0000", stream_name="test-stream"):
    """
...
@task
def local_logs(system_name="0000", stream_name="test-stream"):
    """
    ...
    if not local_is_deployed(system_name, stream_name):
...
@task
def local_stats(system_name="0000", stream_name="test-stream"):
    """
...
def build_name(system_name="0000", stream_name="test-stream"):
    return f"StreamApp_{system_name}_{stream_name}"
