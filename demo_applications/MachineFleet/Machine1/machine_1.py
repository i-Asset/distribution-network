...
def produce_metrics(interval=10):
    while not halt_event.is_set():
        ...
        print(
            f"The demo machine 1 is at [{latitude}, {longitude}],   \twith the temp.: {temperature} °C  \tand had a " +
...
if __name__ == "__main__":
    ...
    # Create an instance of the CarSimulator that simulates a machine driving on different tracks through Salzburg
